...
formula.pcinc <- update(formula.full, .~.-loghhinc.ctr+logpcinc.ctr)
```
...
models.pcinc <- lapply(analytical_samples, function(analytical_data) {
  model <- glmer(formula.pcinc, data=analytical_data, family=binomial)
  model <- check.convergence(model, analytical_data)
  return(model)
})
...
pooled_results <- lapply(list(models.anova, models.basic, models.demog, 
                              ...
                              models.asvab, models.controls, models.pcinc),
                         poolModels)
...
stargazer(models.anova[[1]], models.basic[[1]], models.demog[[1]], models.familybg[[1]],
          ...
          type="html", keep.stat=c("n"), star.cutoffs=c(0.05,0.01,0.001),
          ...
          covariate.labels=c("Multiple race parentage","Hispanic parent",
                            ...
                            "Highest parental years of education",
                            "Household income (logged)",
                            "No high school diploma, not enrolled",
                            "College degree or college enrollment", 
                            "Enrolled in high school",
                            "CAT-ASVAB score","High school GPA", "Female",
                            "Urban area","per capita income (logged)"),
          dep.var.labels="",
          dep.var.caption = "",
          ...
          notes=c("<em>&#42;p&lt;0.05;&#42;&#42;p&lt;0.01;&#42;&#42;&#42;p&lt;0.001</em>",
                  "Reference categories are non-two biological parent household,",
